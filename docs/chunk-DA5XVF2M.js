import{Ab as y,Bb as w,Fa as g,Ia as m,M as o,Sa as v,Ta as u,Xa as a,Y as p,Ya as l,bb as h,fb as b,gb as f,hb as x,jb as n,kb as t,pb as C,qb as E,wa as s}from"./chunk-QYBIWH6M.js";var A=(e=>(e.CSS="language-css",e.HTML="language-html",e))(A||{});var R=(e=>(e.ROW="rows",e.COLUMN="columns",e))(R||{}),S=(e=>(e.ROW="example row",e.COLUMN="example column",e))(S||{}),H=(r=>(r.ROW="row",r.COLUMN="column",r.DENSE="dense",r))(H||{}),T=(e=>(e.COLUMNROW="grid-column / grid-row",e.AREA="grid-area",e))(T||{});var I=["codeBlock"];function P(d,i){if(d&1&&(a(0,"p",2),n(1),C(2,"translate"),l()),d&2){let e=h();s(),t(E(2,1,e.title))}}var N=class d{title;code;language;codeBlock;firstRender=!1;ngAfterViewInit(){this.highlightCode(),this.firstRender=!0}ngOnChanges(i){i.code&&this.firstRender&&this.highlightCode()}highlightCode(){this.codeBlock?.nativeElement&&(this.codeBlock.nativeElement.textContent=this.code??"",Prism.highlightElement(this.codeBlock.nativeElement))}static \u0275fac=function(e){return new(e||d)};static \u0275cmp=g({type:d,selectors:[["app-code"]],viewQuery:function(e,r){if(e&1&&b(I,7),e&2){let c;f(c=x())&&(r.codeBlock=c.first)}},inputs:{title:"title",code:"code",language:"language"},features:[p],decls:6,vars:4,consts:[["codeBlock",""],[1,"code","mt-4"],[1,"code__title","blue"]],template:function(e,r){e&1&&(a(0,"div",1),m(1,P,3,3,"p",2),a(2,"pre")(3,"code",null,0),n(5),l()()()),e&2&&(s(),u(r.title?1:-1),s(2),v(r.language),s(2),t(r.code))},dependencies:[w,y],styles:["code[class*=language-][_ngcontent-%COMP%], pre[class*=language-][_ngcontent-%COMP%]{margin:0;padding:0}.code__title[_ngcontent-%COMP%]{font-size:1rem;font-weight:600;margin:0 0 1rem}@media (max-width: 576px){code[class*=language-][_ngcontent-%COMP%], pre[class*=language-][_ngcontent-%COMP%]{font-size:.8rem!important}}"]})};var O=class d{getHmlBlock(){return`<div class="container">
